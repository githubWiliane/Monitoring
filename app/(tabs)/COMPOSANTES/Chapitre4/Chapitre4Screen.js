...
export default function Chapitre4Screen() {
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      {/* Image principale */}
      <Image
        source={require('../Chapitre4/poissons-elevage-1.jpg')} // Remplacez avec votre image
        style={styles.image}
      />
      ...
      {/* Image illustrative */}
      <Image
        source={require('../Chapitre4/image.webp')} // Image supplémentaire
        style={styles.image}
      />
    ...
    {'\n'}- Perche : Poisson carnivore, apprécié pour sa chair délicate.
      ...
      <Image
        source={require('../Chapitre4/pisciculture-ferme-piscicole-en-Afrique.jpg')} // Remplacez avec une image de poissons d'eau douce
        style={styles.image}
      />
      ...
      <Image
        source={require('../Chapitre4/fcc1c2dd286e4ccc92d81a3ad9337cce.jpg')} // Remplacez avec une image de poissons d'eau salée
        style={styles.image}
      />
      ...
      <Image
        source={require('../Chapitre4/pisciculture-etang-solution1.jpg')} // Remplacez avec une image de poisson d'aquaculture
        style={styles.image}
      />
      ...
      <Image
        source={require('../Chapitre4/Sans-titre-18.png')} // Remplacez avec une image représentant le choix d'un poisson
        style={styles.image}
      />
      ...
      <Image
        source={require('../Chapitre4/image.webp')} // Remplacez avec une image de poisson malade
        style={styles.image}
      />

      {/* Conclusion */}
      <Text style={styles.content}>
        Choisir les bonnes espèces de poissons est un élément clé pour une pisciculture réussie. {'\n'}Il est essentiel de prendre en compte les 
