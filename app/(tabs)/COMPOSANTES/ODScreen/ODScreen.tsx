...
const TemperatureScreen = () => {
  ...
  return (
    <Animated.View style={[styles.container, { backgroundColor: animatedBackgroundColor }]}>
      {/* Icône locale */}
      <Image
        source={require('../ODScreen/OD.png')} // Ajuster le chemin de l'icône
        style={styles.icon}
        resizeMode="contain"
      />

      <Text style={styles.label}>Oxygène dissous dans l'eau</Text>
      ...
      <Text style={styles.value}>{oxygenLevel} mg/L</Text>
    </Animated.View>
  );
};
