...
const Salinitecreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Image
        source={require('../SaliniteScreen/salinite.png')} // Chemin relatif à votre icône locale
        style={styles.icon}
        resizeMode="contain"
      />

      <Text style={styles.label}>Salinité de l'eau</Text>
      ...
      <Text style={styles.value}>{temperature}g/L</Text>
